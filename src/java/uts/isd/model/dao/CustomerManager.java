...
public class CustomerManager {
    ...
    /*
        CREATE OPERATION: Create customer user & initialize all fields except for ID
    ...
    */
    public void addUser(String email, String name, String password, String dob, String phone, String address, String role) throws SQLException {
        String columns = "insert into iotdb.CUSTOMER(EMAIL,\"NAME\",PASSWORD,DOB,PHONE,ADDRESS,ROLE)";
    ...
    /*
        RETRIEVE OPERATION: Find customer user by email and password in the database
    ...
    */
    public Customer findUser(String email, String password) throws SQLException {
        ...
        String fetch = "SELECT * FROM IOTDB.CUSTOMER WHERE EMAIL='"+email+"' AND PASSWORD='"+password+"'";// read from where email = and password =
    ...
    /*
        UPDATE OPERATION: Update all fields of customer user based on ID
    */    
    public void updateUser(int ID, String email, String name, String password, String dob, String phone, String address, String role) throws SQLException {       
        ...
        String update = "update iotdb.CUSTOMER set EMAIL='"+email+"', NAME='"+name+"', PASSWORD='"+password+"', DOB='"+dob+"', PHONE='"+phone+"', ADDRESS='"+address+"', ROLE='"+role+"'";
    ...
    /*
        DELETE OPERATION: Delete customer user based on ID
    */
    public void deleteUser(int ID) throws SQLException{       
       //code for delete-operation   
       String delete = "delete from iotdb.CUSTOMER where ID="+ID+"";
